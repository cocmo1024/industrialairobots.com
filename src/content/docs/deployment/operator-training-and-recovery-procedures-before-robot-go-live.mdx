...
Operators should not be expected to improvise around unclear safety boundaries, program edits, or ambiguous machine states. Training should expand confidence inside the allowed recovery envelope, not push risk down to the shift team.

## Why this page matters

This topic is a recurring cause of rollout failure because it sits between integration sign-off and live production reality. Plants often discover too late that the robot was commissioned, but not operationally handed over.
